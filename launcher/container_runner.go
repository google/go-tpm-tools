...
// const (
//
//	// hostTokenPath defined the directory in the host that will store launcher related files.
//	hostLauncherPath = "/tmp/container_launcher/"
//	// ContainerTokenMountPath defined the directory in the container stores attestation tokens and
//	// other launcher provided files.
