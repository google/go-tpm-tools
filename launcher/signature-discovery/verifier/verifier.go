// Package verifier contains verification functionalities for signatures generated by various signing algorithms.
package verifier
...
// Verifier verifies a digital signature.
type Verifier interface {
	VerifySignature(payload, signature []byte, pubKey crypto.PublicKey) error
}

// VerifyOCISignature verifies an oci.Signature and returns error if the signature verification failed.
...
// LoadVerifier loads a signature verifier based on the given signing algorithm.
