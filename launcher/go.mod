...
require (
	...
	github.com/GoogleCloudPlatform/confidential-space/server v0.0.0-20260401004222-540adab6eec6
	...
	github.com/google/go-tpm-tools/agent v0.0.0-20260403195314-f0258fcebbfd
