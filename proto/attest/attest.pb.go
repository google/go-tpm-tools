...
type AttestedCosState struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Container        *ContainerState        `protobuf:"bytes,1,opt,name=container,proto3" json:"container,omitempty"` // Keep for backward compatibility
	...
	Containers       []*ContainerState      `protobuf:"bytes,6,rep,name=containers,proto3" json:"containers,omitempty"` // New field
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AttestedCosState) GetContainers() []*ContainerState {
	if x != nil {
		return x.Containers
	}
	return nil
...
const file_attest_proto_rawDesc = "" +
	...
	"\x0f_memory_enabled\"\xab\x01\n" +
	"\x0eGpuDeviceState\x120\n" +
	"\acc_mode\x18\x01 \x01(\x0e2\x17.attest.GPUDeviceCCModeR\x06ccMode\x12g\n" +
	"\x19nvidia_attestation_report\x18\x02 \x01(\v2+.confidential_space.NvidiaAttestationReportR\x17nvidiaAttestationReport\"\x8c\x03\n" +
	...
	"\x10gpu_device_state\x18\x05 \x01(\v2\x16.attest.GpuDeviceStateR\x0egpuDeviceState\x126\n" +
	"\n" +
	"containers\x18\x06 \x03(\v2\x16.attest.ContainerStateR\n" +
	"containers\" \n" +
	"\x06EfiApp\x12\x16\n" +
	"\x06digest\x18\x01 \x01(\fR\x06digest\"\xbc\x01\n" +
	"\bEfiState\x12\"\n" +
	"\x04apps\x18\x01 \x03(\v2\x0e.attest.EfiAppR\x04apps\x12B\n" +
	"\x15boot_services_drivers\x18\x02 \x03(\v2\x0e.attest.EfiAppR\x13bootServicesDrivers\x12H\n" +
	"\x18runtime_services_drivers\x18\x03 \x03(\v2\x0e.attest.EfiAppR\x16runtimeServicesDrivers\"\x93\x04\n" +
	"\fMachineState\x121\n" +
...
var file_attest_proto_depIdxs = []int32{
	...
	15, // 26: attest.AttestedCosState.containers:type_name -> attest.ContainerState
	20, // 27: attest.EfiState.apps:type_name -> attest.EfiApp
	20, // 28: attest.EfiState.boot_services_drivers:type_name -> attest.EfiApp
	20, // 29: attest.EfiState.runtime_services_drivers:type_name -> attest.EfiApp
	7,  // 30: attest.MachineState.platform:type_name -> attest.PlatformState
	14, // 31: attest.MachineState.secure_boot:type_name -> attest.SecureBootState
	11, // 32: attest.MachineState.raw_events:type_name -> attest.Event
	33, // 33: attest.MachineState.hash:type_name -> tpm.HashAlgo
	9,  // 34: attest.MachineState.grub:type_name -> attest.GrubState
	10, // 35: attest.MachineState.linux_kernel:type_name -> attest.LinuxKernelState
	19, // 36: attest.MachineState.cos:type_name -> attest.AttestedCosState
	21, // 37: attest.MachineState.efi:type_name -> attest.EfiState
	30, // 38: attest.MachineState.sev_snp_attestation:type_name -> sevsnp.Attestation
	31, // 39: attest.MachineState.tdx_attestation:type_name -> tdx.QuoteV4
	0,  // 40: attest.PlatformPolicy.minimum_technology:type_name -> attest.GCEConfidentialTechnology
	24, // 41: attest.SevSnpPolicy.uefi:type_name -> attest.RIMPolicy
	23, // 42: attest.Policy.platform:type_name -> attest.PlatformPolicy
	25, // 43: attest.Policy.sev_snp:type_name -> attest.SevSnpPolicy
