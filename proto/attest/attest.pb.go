...
type Certificate_WellKnownCertificate int32

const (
	Certificate_UNKNOWN Certificate_WellKnownCertificate = 0
	// Microsoft certs: https://go.microsoft.com/fwlink/p/?linkid=321192
	Certificate_MS_WINDOWS_PROD_PCA_2011    Certificate_WellKnownCertificate = 1
	Certificate_MS_THIRD_PARTY_UEFI_CA_2011 Certificate_WellKnownCertificate = 2
)

// Enum value maps for Certificate_WellKnownCertificate.
var (
	Certificate_WellKnownCertificate_name = map[int32]string{
		0: "UNKNOWN",
		1: "MS_WINDOWS_PROD_PCA_2011",
		2: "MS_THIRD_PARTY_UEFI_CA_2011",
	}
	Certificate_WellKnownCertificate_value = map[string]int32{
		"UNKNOWN":                     0,
...
func (x Certificate_WellKnownCertificate) Enum() *Certificate_WellKnownCertificate {
	p := new(Certificate_WellKnownCertificate)
	*p = x
	return p
}

func (x Certificate_WellKnownCertificate) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Certificate_WellKnownCertificate) Descriptor() protoreflect.EnumDescriptor {
	return file_attest_proto_enumTypes[1].Descriptor()
}

func (Certificate_WellKnownCertificate) Type() protoreflect.EnumType {
	return &file_attest_proto_enumTypes[1]
}

func (x Certificate_WellKnownCertificate) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Certificate_WellKnownCertificate.Descriptor instead.
func (Certificate_WellKnownCertificate) EnumDescriptor() ([]byte, []int) {
	return file_attest_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *Certificate) GetWellKnown() Certificate_WellKnownCertificate {
...
type Certificate_WellKnown struct {
	WellKnown Certificate_WellKnownCertificate `protobuf:"varint,2,opt,name=well_known,json=wellKnown,proto3,enum=attest.Certificate_WellKnownCertificate,oneof"`
}
...
var file_attest_proto_rawDesc = []byte{
	...
	,
	...
	0x5f, 0x55, 0x45, 0x46, 0x49, 0x5f, 0x43, 0x41, 0x5f, 0x32, 0x30, 0x31, 0x31, 0x10, 0x02, 0x42,
	0x10, 0x0a, 0x0e, 0x72, 0x65, 0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x22, 0x4d, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x29, 0x0a,
	0x05, 0x63, 0x65, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x61,
	...
	0x22, 0xa1, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x42, 0x6f, 0x6f, 0x74, 0x53,
	...
	,
	...
	0x61, 0x73, 0x68, 0x22, 0xde, 0x01, 0x0a, 0x0e, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d,
	...
	,
...
var file_attest_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_attest_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_attest_proto_goTypes = []interface{}{
	(GCEConfidentialTechnology)(0),        // 0: attest.GCEConfidentialTechnology
	(Certificate_WellKnownCertificate)(0), // 1: attest.Certificate.WellKnownCertificate
	(*GCEInstanceInfo)(nil),               // 2: attest.GCEInstanceInfo
	(*Attestation)(nil),                   // 3: attest.Attestation
	(*PlatformState)(nil),                 // 4: attest.PlatformState
	(*Event)(nil),                         // 5: attest.Event
	(*Certificate)(nil),                   // 6: attest.Certificate
	(*Database)(nil),                      // 7: attest.Database
	(*SecureBootState)(nil),               // 8: attest.SecureBootState
	(*MachineState)(nil),                  // 9: attest.MachineState
	(*PlatformPolicy)(nil),                // 10: attest.PlatformPolicy
	(*Policy)(nil),                        // 11: attest.Policy
	(*tpm.Quote)(nil),                     // 12: tpm.Quote
	(tpm.HashAlgo)(0),                     // 13: tpm.HashAlgo
}
var file_attest_proto_depIdxs = []int32{
	12, // 0: attest.Attestation.quotes:type_name -> tpm.Quote
	2,  // 1: attest.Attestation.instance_info:type_name -> attest.GCEInstanceInfo
	0,  // 2: attest.PlatformState.technology:type_name -> attest.GCEConfidentialTechnology
	2,  // 3: attest.PlatformState.instance_info:type_name -> attest.GCEInstanceInfo
	1,  // 4: attest.Certificate.well_known:type_name -> attest.Certificate.WellKnownCertificate
	6,  // 5: attest.Database.certs:type_name -> attest.Certificate
	7,  // 6: attest.SecureBootState.db:type_name -> attest.Database
	7,  // 7: attest.SecureBootState.dbx:type_name -> attest.Database
	7,  // 8: attest.SecureBootState.authority:type_name -> attest.Database
	4,  // 9: attest.MachineState.platform:type_name -> attest.PlatformState
	8,  // 10: attest.MachineState.secure_boot:type_name -> attest.SecureBootState
	5,  // 11: attest.MachineState.raw_events:type_name -> attest.Event
	13, // 12: attest.MachineState.hash:type_name -> tpm.HashAlgo
	0,  // 13: attest.PlatformPolicy.minimum_technology:type_name -> attest.GCEConfidentialTechnology
	10, // 14: attest.Policy.platform:type_name -> attest.PlatformPolicy
